                ...
                <form action="/alternatif/{{$alternatif->id}}" method="POST">
                    ...
                    <div class="controls">
                        ...
                        <div class="form-group">
                            ...
                            <input id="iso" type="text" name="iso" class="form-control" value="{{$alternatif->iso}}"
                                placeholder="Please enter iso alternatif" required="required"
                                >
                        </div> <div class="form-group">
                            <label for="resolusi">Resolusi *</label>
                            <input id="resolusi" type="text" name="resolusi" class="form-control" value="{{$alternatif->resolusi}}"
